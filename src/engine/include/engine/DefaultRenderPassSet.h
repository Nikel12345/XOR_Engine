...
namespace DefaultRenderPassNamespace
{
    ...
    struct alignas(16) BloomState {
        ...
        // Доля эффект-домена у уровня 0 пирамиды (дальше /2 на уровень). Живёт ЗДЕСЬ, а не в общей
        // настройке набора: проходы — открытое множество, и доля есть только у вошедшего в него эффекта.
