...
struct ModelIdTag;
struct ShaderProgramIdTag;
struct ComputeProgramIdTag;
...
using ShaderProgramId  = ResourceId<ShaderProgramIdTag>;
using ComputeProgramId = ResourceId<ComputeProgramIdTag>;
