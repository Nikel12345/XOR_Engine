...
public:
    ...
    // EntityRevision НЕ двигает — решает вызывающий (staging-сцене формы это не нужно).
    ...
    // Сравнивают её со своей запомненной копией сколько угодно потребителей и послотно — та же
    // дисциплина, что у BatchBuilder::BatchesRevision.
