...
// 2 сэмплера (albedo t0, normal t1) + LightBlock t2 (объявляет база) → префикс t3, состояния t4.
StructuredBuffer<int>  TexStatePrefix : register(t3, space2);
StructuredBuffer<uint> TexState       : register(t4, space2);
