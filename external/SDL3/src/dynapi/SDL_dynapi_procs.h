...
/* ENGINE-FORK: без записи здесь функция не попадает в таблицу переходов dynapi и не
 * экспортируется из SDL3.dll — линковка падает на неразрешённом символе. Любая новая
 * публичная функция форка должна добавляться сюда же. */
